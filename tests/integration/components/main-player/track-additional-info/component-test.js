...
/*    this.set('title', "Track Title");
    ...
    await render(hbs`
      {{#main-player/track-additional-info conductorName=conductor ensembleName=ensemble}}
        {{title}}
      {{/main-player/track-additional-info}}
      `);
...
/*    this.set('title', "Track Title");
    ...
    await render(hbs`{{#main-player/track-additional-info conductorName=conductor ensembleName=ensemble}}
      {{title}}
    {{/main-player/track-additional-info}}`);
